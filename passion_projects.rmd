...
Throughout 2020, I grew increasingly distraght by the injustices experienced by Black and African American individuals by police and others across the United States. I embarked more earnestly on a path to better educate myself on what systemic racism looks like, and joined groups that engaged in promoting social equity and anti-racism. I view this learning / unlearning / action not as elective work, but morally imperative work. Half of the battle to implement anti-racist policies (recognized by scholars like bell hooks) is convincing folks that racism actually exists *here*, not just in the hand-wavy world around us, but here, in this classroom, in this department, and in this university, bolstering all of our instistutional structures, personal interactions, and distinguished pathways for upward social mobility.

Two groups have been paramount to my education and work in this space, the first being my department's Geography Diversity, Equity, and Inclusion Working Group, and the second being UCSB's CITRAL Community of Practice. Both have provided a formal setting by which like-minded folks can meet, educate one another, discuss, and enact social change. Below are links to explore these groups further, and I sincerely welcome any ideas or resources to engage in similar thinking and action.
...
Acceptance into the CoP is competitive and selected applicants typically already have a track record of thoughtful action toward equitable teaching. Participants meet six times over the course of two quarters, and they complete additional partnered and independent work between the meetings. A brief summary of the CoP is attached. At the end of the CoP, participants have 1) read about and discussed several frameworks that inform equitable and antiracist teaching; 2) developed or revised teaching portfolio materials such as syllabi and DEI statements to align with some of these frameworks; and 3) contributed to a community sharing resources, experiences, feedback, and knowledge.
We recruit participants based on our belief that they will thrive in and fruitfully contribute to a community of thoughtful, generous, and innovative instructors. For questions about the instructor’s participation in the program, contact the facilitator of the CoP, Dr. Elina Salminen, at salminen@ucsb.edu.
...
I joined the UC Davis Placemaking team to help create a map of all of the initiative's affiliations between projects and people: who works with whom and where do practitioners reside, both in terms of their geographic location as well as their place-based organizations. A copy of the map of these affiliations is given below. You can view affiliations by people or projects, and the websites associated with them are attached as attributes on the nodes and edges of the network.
...
Having advanced to candidacy and hardly engaging in formal coursework, I felt the need to maintain my knowledge and skills in machine learning. I decided to take on Kaggle's 30 Days of Machine Learning (ML) challenge, and despite not being able to do it in the designated 30 days, I was able to complete the tutorials for the challenge later during my winter break. I really enjoyed the tutorials and look forward to doing more Kaggle competitions in the future! My silly certificates are below.
