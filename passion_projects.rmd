---
#layout: post
title: 'Service and Passion Projects'
#tab: second
...
After the death of George Floyd in 2020, I embarked on a path to better educate myself on systemic racism and joined groups that engaged in actively anti-racist, social equity work. I view this learning and action as morally imperative work that needs to be more rigorously addressed in academia. Half of the battle to implement anti-racist policies (recognized by scholars like bell hooks) is convincing folks that racism actually exists *here*, not just in the hand-wavy world around us, but here, in this classroom, in this department, and in this university.

Two groups have been paramount to my education and work in this space. The first was my department's Diversity, Equity, and Inclusion Working Group, and the second was UCSB's Center for Innovative Teaching, Learning, and Research (CITRAL). Both provided a formal setting by which folks could meet, educate one another, discuss, and enact social change. Below are links to explore these groups further.
